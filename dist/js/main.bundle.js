...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsSlider = __webpack_require__(1);

	var _componentsSlider2 = _interopRequireDefault(_componentsSlider);

	var _componentsTimeSelector = __webpack_require__(2);

	var _componentsTimeSelector2 = _interopRequireDefault(_componentsTimeSelector);
	...
	var Form = (function (_React$Component) {
		...
		_createClass(Form, [{
			...
			key: '_handleTime',
			value: function _handleTime(value) {
				this.setState({ time: value });
			}
		}, {
			key: '_handleCount',
			value: function _handleCount(value) {
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'form',
						{ onSubmit: this._onSubmit, action: '.' },
						_react2['default'].createElement(_componentsSlider2['default'], { onChange: this._handleCount, min: 1, max: 21 }),
						_react2['default'].createElement(_componentsTimeSelector2['default'], { onChange: this._handleTime })
					)
				);
			}
		}]);
	...
	var Recover = (function (_React$Component2) {
		function Recover() {
			_classCallCheck(this, Recover);

			_get(Object.getPrototypeOf(Recover.prototype), 'constructor', this).call(this);
			this._onClick = this._onClick.bind(this);
		}

		_inherits(Recover, _React$Component2);
		...
		_createClass(Recover, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ ref: 'container', className: 'recover' },
					_react2['default'].createElement('i', { className: 'recover__patient' }),
					_react2['default'].createElement('i', { onClick: this._onClick, className: 'recover__pill pulse' })
				);
			}
		}]);
	...
	var Scene = (function (_React$Component3) {
		function Scene() {
		...
		_createClass(Scene, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(Recover, null),
	...
	_react2['default'].render(_react2['default'].createElement(Scene, null), document.getElementById('page-scene'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixinsEvents = __webpack_require__(4);
	...
	var Slider = (function (_React$Component) {
		...
		_createClass(Slider, [{
			...
			value: function componentWillMount() {
				_mixinsEvents2['default'].addEvent(window, 'resize', this._onResize);
			}
		}, {
			...
			value: function _onDragStart(e) {
				...
				_mixinsEvents2['default'].addEvent(window, _mixinsEvents2['default'].dragEventFor['move'], this._onDrag);
				_mixinsEvents2['default'].addEvent(window, _mixinsEvents2['default'].dragEventFor['end'], this._onDragEnd);
				this._pauseEvent(e);
			}
		}, {
			key: '_onDrag',
			...
			value: function _onDragEnd(e) {
				...
				_mixinsEvents2['default'].removeEvent(window, _mixinsEvents2['default'].dragEventFor['move'], this._onDrag);
				_mixinsEvents2['default'].removeEvent(window, _mixinsEvents2['default'].dragEventFor['end'], this._onDragEnd);
			}
		}, {
			key: 'normValue',
			value: function normValue(value) {
				return Math.min(this.props.max, Math.max(this.props.min, value));
			}
		}, {
			key: 'getOffset',
			value: function getOffset(value) {
			...
			value: function renderLabels() {
				...
				for (var i = this.props.min; i <= this.props.max; i++) {
					...
					elmsList.push(_react2['default'].createElement(
						'li',
						{ className: clsName, style: { left: this.getOffset(i) + 'px' } },
						i
					));
				}
				return elmsList;
			...
			value: function renderCursor() {
				return _react2['default'].createElement(_Cursor2['default'], { onDragStart: this._onDragStart, onDragEnd: this._onDragEnd, offset: this.getOffset(this.state.value) });
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'ol',
							{ className: 'slider__labels' },
							this.renderLabels()
						),
						_react2['default'].createElement(
							'div',
							{ className: 'slider' },
							_react2['default'].createElement('i', { className: 'slider__bar' }),
							this.renderCursor()
						)
					),
					_react2['default'].createElement(
						'label',
						{ className: 'patient__label' },
	...
	Slider.defaultProps = { min: 0, max: 100, value: 0, onChange: function onChange() {} };
	Slider.propTypes = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var periodChoices = { day: { value: 1, label: 'день' }, week: { value: 2, label: 'неделя' }, month: { value: 3, label: 'месяц' } };

	var TimeSelector = (function (_React$Component) {
		function TimeSelector() {
			_classCallCheck(this, TimeSelector);

			_get(Object.getPrototypeOf(TimeSelector.prototype), 'constructor', this).call(this);
			this.state = { value: 0 };
			this._onClick = this._onClick.bind(this);
		}
					...
					_react2['default'].createElement(
						...
						Object.keys(periodChoices).map((function (key) {
							...
							return _react2['default'].createElement(
								...
								_react2['default'].createElement(
									'button',
									{ onClick: this._onClick, 'data-period': key, className: className },
	...
	TimeSelector.defaultProps = { onChange: function onChange() {} };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	event.dragCamelCaseEventFor = (function () {
	  var eventsFor = {
	    touch: {
	      start: 'TouchStart',
	      move: 'TouchMove',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cursor = (function (_React$Component) {
		...
		_createClass(Cursor, [{
			...
			value: function render() {
				var props = {};
				props['on' + _mixinsEvents2['default'].dragCamelCaseEventFor['start']] = this.props.onDragStart;
				props['on' + _mixinsEvents2['default'].dragCamelCaseEventFor['end']] = this.props.onDragEnd;
				props.style = { left: this.props.offset };
				return _react2['default'].createElement('i', _extends({}, props, { className: 'slider__cursor' }));
			}
		}]);
	...
	Cursor.defaultProps = { onDragStart: function onDragStart() {}, onDragEnd: function onDragEnd() {} };
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(18);
	var ReactMarkupChecksum = __webpack_require__(82);
	var ReactServerRenderingTransaction = __webpack_require__(90);
